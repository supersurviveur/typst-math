...
To preview math symbols, some fonts are required, which you can either install [manually](./fonts/README.md) or let the extension install them automatically on first launch (works on Windows only).
